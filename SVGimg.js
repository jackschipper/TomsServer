...
class SVGimg  {
    ...
    draw2Top(doc) {
       ...
       // this.newDiv.appendChild(this.svg);
        ...
        // let post = {coordx: this.svg.style.left, coordy: this.svg.style.top }
    ...
    makeDraggable() {
        ...
        svg.addEventListener('contextmenu', function(event) {
            ...
            // console.log('SIZE BEFORE', svgList.length);
            //   for (var i = 0; i < svgList.length; i++) {
            //     console.log($('#'+svgList[i].id).attr('deleteme'));
            //     if($('#'+svgList[i].id).attr('deleteme') == 1) {
            //       var tempInd = i;
            //       svgList.splice(tempInd, 0);
            //     }
            //  }
            //  console.log('SIZE AFTER', svgList.length);
        });
        ...
        function endDrag(evt) {
            ...
            //    }
                if (svg.style.left != svgList[i].style.left && svg.style.top != svgList[i].style.top) { //code to detect other tables has bug with deleted tables
